module plotting 
  ...
  contains
    ...
    subroutine plot_int_2d (xdata,ydata,ftype)
      implicit none
      character(len=*), intent(in) :: ftype
      integer, INTENT(IN):: ydata(:,:), xdata(:,:)
      call plot_real_2d(real(xdata), real(ydata), ftype)
    end subroutine plot_int_2d

    subroutine plot_int_1d (xdata,ydata,ftype)
      implicit none
      character(len=*), intent(in) :: ftype
      integer, INTENT(IN):: ydata(:), xdata(:)
      call plot_real_1d(real(xdata), real(ydata),ftype)
    end subroutine plot_int_1d

    subroutine plot_real_1d (xdata,ydata,ftype)
      implicit none
      integer :: i
      character(len=*), intent(in) :: ftype
    ...
    subroutine plot_real_2d (xdata,ydata,ftype)
      implicit none
      integer :: i
      character(len=*), intent(in) :: ftype
      real, intent(in):: ydata(:,:), xdata(:,:)
